(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Quarters", [], factory);
	else if(typeof exports === 'object')
		exports["Quarters"] = factory();
	else
		root["Quarters"] = factory();
})(this, function() {
...
var openPopup = function openPopup(url) {
  var width = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 850;
...
var Quarters = function () {
  ...
  _createClass(Quarters, [{
    key: '_getAxiosObject',
    value: function _getAxiosObject(apiToken) {
      var _this = this;
      ...
      var obj = _axios2.default.create(options);
      if (intercept) {
        // intercept response to check if 401 (Unauthorized with code 'token-expired')
        obj.interceptors.response.use(function (response) {
          return response;
        }, function (error) {
          var orgRequest = error.config;
          if (error.response.status === 401 && error.response.data && error.response.data.code === 'token-expired' && !orgRequest._retry) {
            orgRequest._retry = true;
            _this.refreshAccessToken().then(function (data) {
              var access_token = data.access_token; // eslint-disable-line

              orgRequest.headers['Authorization'] = 'Bearer ' + access_token; // eslint-disable-line
              return (0, _axios2.default)(orgRequest);
            });
          }
    ...
    value: function _requestFromQuarters(url, type, success) {
      var _this2 = this;

      if (type === 'redirect') {
        var redirectURI = encodeURIComponent(location.protocol + '//' + location.host + location.pathname);
      ...
      var receiveMessage = function receiveMessage(event) {
        if (event.origin !== _this2.options.quartersURL) {
          return;
        }
      ...
      var iframeURL = url + '&frame_id=' + frameId;
      var f = document.createElement('IFRAME');
      f.setAttribute('src', iframeURL);
      f.setAttribute('id', frameId);
      f.setAttribute('style', 'position: fixed; width: 100%; height: 100%; top: 0; left: 0; right: 0; bottom: 0; z-index: 1000; border: 0px none transparent; background-color: transparent;');
    ...
    value: function authorize() {
      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'iframe';
      var success = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};

      var oauthURL = this.options.oauthURL;
      var url = oauthURL + '/oauth/authorize?response_type=code&client_id=' + this.options.appKey + '&inline=true';

      return this._requestFromQuarters(url, type, success);
    }
  }, {
    key: 'setAuthCode',
    value: function setAuthCode(code) {
      var _this3 = this;
      ...
      return _axios2.default.post(this.options.apiURL + 'oauth/token', data).then(function (response) {
        ...
        _this3.refreshToken = refresh_token; //  eslint-disable-line
        _this3.axiosObject = _this3._getAxiosObject(access_token);
    ...
    value: function refreshAccessToken() {
      ...
      return _axios2.default.post(this.options.apiURL + 'oauth/token', data).then(function (response) {
        ...
        _this4.axiosObject = _this4._getAxiosObject(access_token);
        return response.data;
      });
    }
    ...
    key: 'me',
    value: function me() {
      return this.axiosObject.get('/me').then(function (response) {
        return response.data;
      });
    }
    ...
    value: function getAccount() {
      ...
      if (this.account) {
        return new Promise(function (resolve) {
          resolve(_this5.account);
        });
      }

      return this.axiosObject.get('/accounts').then(function (response) {
        return response.data;
      }).then(function (accounts) {
        if (accounts.length > 0) {
          _this5.account = accounts[0];
        }

        return _this5.account;
      });
    }
    ...
    value: function getBalance() {
      ...
      return this.getAccount().then(function (account) {
        return _this6.axiosObject.get('/accounts/' + account.address + '/balance');
    ...
    key: 'requestTransfer',
    value: function requestTransfer(data) {
      if (!data.tokens) {
      ...
      var payload = {
        ...
        // request tokens
      };return this.axiosObject.post('/requests', payload).then(function (response) {
        return response.data;
      });
    }
    ...
    value: function authorizeTransfer(requestId) {
      ...
      var oauthURL = this.options.oauthURL;
      var url = oauthURL + '/requests/' + requestId + '?client_id=' + this.options.appKey + '&inline=true';
