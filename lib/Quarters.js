...
var Quarters = function () {
  ...
  _createClass(Quarters, [{
    ...
    value: function authorize() {
      ...
      var url = oauthURL + '/oauth/authorize?response_type=code&client_id=' + this.options.appKey;
      if (options.redirect) {
    ...
    key: 'requestTransfer',
    value: function requestTransfer(tokens) {
      var data = {
        tokens: tokens

        // request tokens
      };return this.axiosObject.post('/request-tokens', data).then(function (response) {
        // success
      });
    }
  }, {
