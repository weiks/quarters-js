...
export default class Quarters {
   ...
   * @param forceSignup: boolean. Force users to sign up
   * @param autoAuthorize: boolean. Enable auto authorize
   */
  authorize(type = 'iframe', success = () => {}, forceSignup = false, autoAuthorize = false) {
